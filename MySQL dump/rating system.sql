...
CREATE TABLE `driver_rating` (
  ...
  KEY `fk_DR_driverId_idx` (`driverID`),
  CONSTRAINT `fk_DR_driverId` FOREIGN KEY (`driverID`) REFERENCES `driver` (`driver_id`)
...
INSERT INTO `driver_rating` VALUES (1,3,5),(2,5,3),(3,4,2),(4,3,5),(5,4,6),(6,1,1),(7,4,6),(8,3,1),(9,3,6),(10,1,1),(11,2,5),(12,5,1),(13,2,2),(14,4,1),(15,5,3),(16,4,2),(17,1,1),(18,3,5),(19,5,8),(20,1,1);
...
CREATE TABLE `restaurant_rating` (
  `rest_rating_id` int NOT NULL AUTO_INCREMENT,
  `rating` int DEFAULT NULL,
  `restaurant_ID` int NOT NULL,
  PRIMARY KEY (`rest_rating_id`),
  KEY `fk_R_rest_ID_idx` (`restaurant_ID`),
  CONSTRAINT `fk_R_rest_ID` FOREIGN KEY (`restaurant_ID`) REFERENCES `restaurant` (`restaurant_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (1,4,46),(2,4,3),(3,3,5),(4,3,15),(5,1,25),(6,3,30),(7,2,35),(8,4,14),(9,1,6),(10,2,5),(11,3,48),(12,1,23),(13,5,43),(14,4,41),(15,2,39),(16,4,16),(17,2,26),(18,5,34),(19,5,15),(20,1,28);
...
-- Dump completed on 2021-04-02 16:28:47
